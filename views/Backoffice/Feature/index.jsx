...
const Features = () => {
  ...
  const [fetchUrl, setFetchUrl] = useState(`api/features/getAllByAccountId/10`);
  ...
  useEffect(() => {
    setFetchUrl(`api/features/getAllByAccountId/${accountId}`);
  }, [accountId, fetchUrl]);
      ...
      <Box sx={{ flexGrow: 1, padding: 3 }}>
        <Grid container spacing={gridSpacing}>
          ...
          <Grid item xs={12}>
            <ReusableDataGrid
              key={accountId}
              title={`Features (Account ${accountId})`}
              fetchUrl={fetchUrl}
              ...
              enableFilters={false}
              editUrl="/masters/features/update"
              deleteUrl="/api/features/delete"
