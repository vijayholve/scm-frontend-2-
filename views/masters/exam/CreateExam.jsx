...
const CreateExam = () => {
  ...
  // State for remaining dropdown options
                ...
                <FieldArray name="examSubjects">
                  {({ push, remove }) => (
                    <>
                        ...
                        <Grid container spacing={2} key={index} alignItems="center" sx={{ mb: 2 }}>
                          <Grid item xs={12} sm={3}>
                            ...
                            >
                              ...
                              {touched.examSubjects?.[index]?.subjectId && errors.examSubjects?.[index]?.subjectId && (
                                <FormHelperText error>{errors.examSubjects[index].subjectId}</FormHelperText>
                              )}
                            </FormControl>
                          </Grid>
                          <Grid item xs={12} sm={3}>
                            ...
                            >
                              ...
                              {touched.examSubjects?.[index]?.quizId && errors.examSubjects?.[index]?.quizId && (
                                <FormHelperText error>{errors.examSubjects[index].quizId}</FormHelperText>
                              )}
                            </FormControl>
                          </Grid>
                          <Grid item xs={12} sm={2}>
                            <TextField
                              ...
                              onBlur={handleBlur}
                              error={Boolean(
                                touched.examSubjects?.[index]?.maxMarksSubject && errors.examSubjects?.[index]?.maxMarksSubject
                              )}
                          ...
                          <Grid item xs={12} sm={2}>
                            <TextField
                              ...
                              onBlur={handleBlur}
                              error={Boolean(
                                touched.examSubjects?.[index]?.passingMarksSubject && errors.examSubjects?.[index]?.passingMarksSubject
                              )}
                              helperText={
                                touched.examSubjects?.[index]?.passingMarksSubject && errors.examSubjects?.[index]?.passingMarksSubject
                              }
                          ...
                          <Grid item xs={12} sm={2}>
                            <TextField
                              ...
                              onBlur={handleBlur}
                              error={Boolean(
                                touched.examSubjects?.[index]?.durationMinutes && errors.examSubjects?.[index]?.durationMinutes
                              )}
                          ...
                          <Grid item xs={12} sm={2}>
                            <IconButton onClick={() => remove(index)} disabled={values.examSubjects.length <= 1}>
                      ...
                      {typeof errors.examSubjects === 'string' && <FormHelperText error>{errors.examSubjects}</FormHelperText>}
                    </>
                  )}
                </FieldArray>
              </Grid>
